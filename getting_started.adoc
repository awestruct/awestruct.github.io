...
== Creating a hassle free Ruby environments
...
=== You want to learn how to Installing rvm on Linux and Mac OSXdddd

To correctly install rvm open a terminal and execute:eeeeeee
...
=== Installing Ruby on Windowssssss
